...
video1 = "v21-noise.mp4"
video2 = "v21-rotate.mp4"
...
def average_similarity(video1, video2):
    ...
    similarities = [
        pHash_sim, dHash_sim, aHash_sim, BMVHash_sim, CNN_sim, Spatio_sim
    ]

    avg_sim = sum(similarities) / len(similarities)
    print(f"Similarity between two videos Similarity: {avg_sim:.2f}%")

    return avg_sim

average_similarity(video1,video2)